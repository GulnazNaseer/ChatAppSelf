...
import com.aa.autotow.chatappself.core.logout.LogoutContract;
import com.aa.autotow.chatappself.core.logout.LogoutPresenter;
import com.aa.autotow.chatappself.ui.adapters.UserListingPagerAdapter;
...
public class UserListingActivity extends AppCompatActivity implements LogoutContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_activity_user_listing);
        bindViews();
        init();
    }
